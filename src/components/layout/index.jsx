...
const MainLayout = () => {
    ...
    // Redirect from root path to calendar page
    // This ensures that if the user navigates to "/", they are redirected to "/calendar"
    if (pathname === "/") {
    ...
    /**
     * Checks if the given page name corresponds to the current pathname.
     *
     * @param {string} pageName - The name of the page to check.
     * @returns {boolean} True if the current pathname matches the URL for the given page name, otherwise false.
     */
