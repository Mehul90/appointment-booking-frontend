        ...
        <div className="p-5">
          ...
          <div className="mt-4 space-y-2">
            <div className="flex items-center text-sm">
              ...
              <a href={`mailto:${participant.email}`} className="text-gray-700 hover:text-indigo-600">
                {participant.email}
              </a>
            </div>
            ...
            {participant.phone && (
              <div className="flex items-center text-sm">
                ...
                <a href={`tel:${participant.phone}`} className="text-gray-700 hover:text-indigo-600">
                  {participant.phone}
                </a>
              </div>
            )}
